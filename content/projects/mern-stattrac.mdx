...
The deployed demo of Stattrac can be found <a href="https://foto-stattrac.herokuapp.com/" target="_blank" rel="noreferrer">here</a>. When searching for a school, omit "University" from any school name. Please note, it may take a moment for the page to load.
