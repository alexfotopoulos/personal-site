...
This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app). Clone or download code from <a href="https://github.com/alexfotopoulos/mern-stattrac" target="_blank">Github</a>.
