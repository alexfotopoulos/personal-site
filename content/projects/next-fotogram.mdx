...
This is a [Next.js](https://nextjs.org/) project bootstrapped with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app). Clone or download code from <a href="https://github.com/alexfotopoulos/next-fotogram" target="_blank">Github</a>.
