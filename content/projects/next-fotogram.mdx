...
While there is basic image/comment creation/deletion and user creation functionalities, there are many features not yet implemented and kinks to be worked out. Thus, the app is not deployed and the repo is private for now.
